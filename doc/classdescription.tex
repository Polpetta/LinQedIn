...
search da implementare per ogni classe derivata. Member implementa già la scrittura
...
Member contiene diverse classi, \textit{Profile} da \textit{Friendships} a
...
Si noti come in DatabaseOnFile (nel codice scritta come \textit{DBonFile})
...
ogni controller che istanzia un Database: infatti un domani ci potrebbe
essere un database per i Membri ma anche uno per gli Amministratori.
